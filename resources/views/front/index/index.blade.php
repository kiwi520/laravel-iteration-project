    ...
    {{--<div class="row">--}}
        <div class="col-sm-8 blog-main">
            ...
            <div>
                ...
                <div class="blog-post">
                    <h2 class="blog-post-title"><a href="/front/index/show/{{$article->id}}" >{{$article->title}}</a></h2>
                    <p class="blog-post-meta">{{$article->created_at->toFormattedDateString()}} by <a href="/user/5">{{$article->user_id}}</a></p>
...
{{--                    {{ $articles->appends(['id' => $article->id ])->links() }}--}}
                    {{ $articles->links() }}
            </div><!-- /.blog-main -->
        </div>
    {{--</div>--}}
